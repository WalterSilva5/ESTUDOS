...
class Lista:
    ...
    def __next__(self):
        if self.__iterando_inverso is None:
            ...
            if self.__iterando is None:
                self.__iterando = self.__último  # pegando o último sempre atualizado
            else:
            ...
            while i <= item:
                ...
                if i == item:
                    if atual.anterior is None:
                        ...
                        # se ainda restou algum elemento, corrigir anterior do primeiro
                        if self.__primeiro is not None:
                            # o novo primeiro elemento não tem mais anterior
                            self.__primeiro.anterior = None
                    elif atual.próximo is None:
                        # apagando o último elemento da lista
                        atual.anterior.próximo = None
                        # o anterior do atual será o novo último
                        self.__último = atual.anterior
                    else:
    ...
    def inserir(self, índice, conteúdo):
        ...
        if self.__primeiro is None:
            ...
            # o anterior do nó que era o primeiro será o novo nó
    ...
    def reverso(self):
        ...
        self.__último, self.__primeiro = self.__primeiro, self.__último
